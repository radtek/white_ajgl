...
public interface IBasicDataService {
	 ...
	 * @param parentId
	 *            上级id
	 * @return 【success : true 同步成功; success : false 同步失败，msg:失败原因;】
	 */
	 ...
	 * @return 【success : true 同步成功; success : false 同步失败，msg:失败原因;】
	 */
	public ResultBean syncAddPersonInfo(String loginName, String loginPass, String orgId, String personName, String id)
	 ...
	 * @return 【success : true 同步成功; success : false 同步失败，msg:失败原因;】
	 */
	public ResultBean syncUpdatePersonInfo(String loginName, String loginPass, String orgId, String personName,
			String id) throws DahuaException;
