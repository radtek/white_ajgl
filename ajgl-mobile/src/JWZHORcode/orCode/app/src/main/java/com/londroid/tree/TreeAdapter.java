...
public class TreeAdapter extends BaseAdapter{
	...
	// 父复选框联动
	private void checkPNode(Node node,boolean isChecked){
		if(node.getParent()!=null)
		{
			if(!isChecked)
			{
				...
				checkPNode(node.getParent(), isChecked);
		}
	}
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			view = this.lif.inflate(R.layout.collection_listview_item_tree, null);
			...
			holder.chbSelect.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					...
					checkPNode(n,((CheckBox)v).isChecked());
