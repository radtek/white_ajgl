...
import com.taiji.article.caseitem.viewmanager.CaseBackAdapter;
...
public class BackFragment extends Fragment {
    public static BackFragment newInstance(String s) {
        BackFragment newFragment = new BackFragment();
    ...
    ListView mListView;
    CaseBackAdapter caseBackAdapter;
    private NoDataView noDataView;
    private LoadingView loadingView;
    TextView case_item_time_tv, case_item_number_tv,case_item_name_tv,case_item_type_tv,case_item_orther_number_tv,case_item_title_name_tv;
    ...
    {
        if(getActivity().getResources().getString(R.string.isTestCaseItemBack).equals("1"))
        {
            refreshTestData();
            return;
        }
        CaseBackStorageData tempData=new CaseBackStorageData();
        ...
        caseBackAdapter.clearDataSource();
            ...
            public void completeBack(String progressId, String result, CaseStorageData caseStorageData) {
                try {
                    if (result.equals("1")) {
                        ...
                        if (caseBackStorageData != null) {
                            setTextViewText(case_item_title_name_tv, caseBackStorageData.scanformCode + "再入库单");
                            setTextViewText(case_item_time_tv, caseBackStorageData.changeDate(caseBackStorageData.DataUpdateTime));
                            setTextViewText(case_item_number_tv, caseBackStorageData.caseCode);
                            setTextViewText(case_item_name_tv, caseBackStorageData.caseName);
                            setTextViewText(case_item_type_tv, caseBackStorageData.outName);
                            setTextViewText(case_item_orther_number_tv, caseBackStorageData.sourceStorageCode);


                            if (caseBackStorageData.l_caseData != null && caseBackStorageData.l_caseData.size() > 0) {
                                caseBackStorageData.sortCaseData(caseBackStorageData.l_caseData);
                                if (caseBackAdapter != null) {
                                    caseBackAdapter.setDataSource(caseBackStorageData.l_view_show_caseData);
                                    caseBackAdapter.notifyDataSetChanged();
                        ...
                        setTextViewText(case_item_title_name_tv, "再入库单信息加载失败");
                        mListView.removeFooterView(loadingView);
                        mListView.addFooterView(noDataView);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fg_case_item_back, container, false);
        mView=view;
        ...
        if(caseBackAdapter ==null)
        {
            caseBackAdapter =new CaseBackAdapter();
            caseBackAdapter.setViewClick(new CaseBackAdapter.viewClickListener() {
                @Override
        ...
        case_item_btn_next_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mBundle.putSerializable("showType", 3);//1入 2出 3返 4调整出 5调整入 6物品详细 7货架详细
                if(caseBackStorageData!=null)
                    mBundle.putSerializable("CaseStorageData", caseBackStorageData);
        ...
        case_item_orther_number_tv=(TextView) view.findViewById(R.id.case_item_orther_number_tv);
        setTextViewText(case_item_orther_number_tv,"");
        ...
        setTextViewText(case_item_title_name_tv,"正在加载再入库单信息...");
/*
...
*/
        ...
        mListView.setAdapter(caseBackAdapter);
        refreshOldData();
        return view;
    }
    ...
    private class FetchItemsTask extends AsyncTask<Integer, Void, CaseBackStorageData> {

        @Override
        protected CaseBackStorageData doInBackground(Integer... params) {
            ...
            tempData.formCode=tempData.scanformCode;
            tempData.DID= tempData.scanformCode;
            tempData.caseCode="FH30032051";
            tempData.caseName="王某一,王某二,王某三非法持有毒品案";
            tempData.outName="随案出库";
            tempData.sourceStorageCode="AS30000001";
            ...
            tempData1.ViewState= 3;
            tempData1.caseItemCountString ="99999包";
            tempData1.caseItemHasCount=999999999;
            tempData1.caseDoItemCount=99999999;
        ...
        protected void onPostExecute(CaseBackStorageData caseStorageData) {
            fetchItemsTaskRun=false;
            mListView.removeFooterView(loadingView);
            fetchItemsTaskRun=false;
            caseBackStorageData =caseStorageData;
            caseBackStorageData.sortCaseData(caseBackStorageData.l_caseData);
            caseBackAdapter.addMoreItems(caseBackStorageData.l_view_show_caseData);
            setTextViewText(case_item_title_name_tv,caseBackStorageData.scanformCode+"再入库单");
            setTextViewText(case_item_time_tv,caseBackStorageData.changeDate(caseBackStorageData.DataUpdateTime));
            setTextViewText(case_item_number_tv,caseBackStorageData.caseCode);
            setTextViewText(case_item_name_tv,caseBackStorageData.caseName);
