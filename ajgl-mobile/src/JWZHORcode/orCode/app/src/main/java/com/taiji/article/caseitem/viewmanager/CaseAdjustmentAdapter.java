 ...
 */
public class CaseAdjustmentAdapter extends PagingBaseAdapter<CaseData> {
    /**
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv2;
        LinearLayout lay;
        CaseAdjustmentData tempData= (CaseAdjustmentData)getItem(position);
        tempData.OrderPosition=position;

       // String text = getItem(position);

        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.case_item_adjustment_list_item, null);
        }
        ...
        tv = (TextView) convertView.findViewById(R.id.case_item_adjustment_list_item_name);
        tv.setText(tempData.caeItemName);

        tv = (TextView) convertView.findViewById(R.id.case_item_adjustment_list_item_earmark);
        setShowShortTextAndAddLongClick(tv,tempData.earmark,27);
       // tv.setText(tempData.earmark);

        tv = (TextView) convertView.findViewById(R.id.case_item_adjustment_list_item_count);
        tv.setText(tempData.caseItemCountString);

        tv = (TextView) convertView.findViewById(R.id.case_item_adjustment_list_item_code_tv);
        tv.setText(tempData.getShowCaseItemNumber());


        tv = (TextView) convertView.findViewById(R.id.case_item_adjustment_list_item_address_tv);
        tv.setText(tempData.lockerOldName);

        tv = (TextView) convertView.findViewById(R.id.case_item_out_list_item_old_address_title_tv);
        if(tempData.caseDoItemCount>0)
        {
            tv.setText("原始位置");
            lay =(LinearLayout) convertView.findViewById(R.id.case_item_Adjustment_list_item_new_address_lay);
            lay.setVisibility(View.VISIBLE);
            tv = (TextView) convertView.findViewById(R.id.case_item_Adjustment_list_item_new_address_tv);
        ...
        tv = (TextView) convertView.findViewById(R.id.case_item_adjustment_list_item_docount_tv);
