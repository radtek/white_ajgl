 ...
 */
public class CaseOutAdapter extends PagingBaseAdapter<CaseData> {
    /**
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // String text = getItem(position);
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.case_item_out_list_item, null);
        }
        ...
        tv = (TextView) convertView.findViewById(R.id.case_item_out_list_item_name);
        tv.setText(tempData.caeItemName);

        tv = (TextView) convertView.findViewById(R.id.case_item_out_list_item_earmark);
        setShowShortTextAndAddLongClick(tv,tempData.earmark,27);
       // tv.setText(tempData.earmark);

        tv = (TextView) convertView.findViewById(R.id.case_item_out_list_item_count);
        tv.setText(tempData.caseItemCountString);

        tv = (TextView) convertView.findViewById(R.id.case_item_out_list_item_code_tv);
        tv.setText(tempData.getShowCaseItemNumber());


        tv = (TextView) convertView.findViewById(R.id.case_item_out_list_item_address_tv);
        tv.setText(tempData.lockerName);

        iv= (ImageView) convertView.findViewById(R.id.case_item_out_list_item_code_iv);
        iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                if (imgClick != null) {
                    try {
                        CaseData caseData = (CaseData) arg0.getTag();
                        imgClick.imgCodeClick(caseData);
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
                }
        ...
        iv= (ImageView) convertView.findViewById(R.id.case_item_out_list_item_code_search_iv);
        iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                if(imgClick!=null)
                {
                    ...
                    {
                        CaseData caseData =(CaseData)arg0.getTag();
                        imgClick.imgAddressClick(caseData);
                    }
                    catch (Exception ex)
                    {
                        ex.printStackTrace();
        ...
        tv = (TextView) convertView.findViewById(R.id.case_item_out_list_item_docount_tv);
