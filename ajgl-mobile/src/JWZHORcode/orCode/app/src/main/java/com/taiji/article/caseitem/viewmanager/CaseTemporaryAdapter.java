 ...
 */
public class CaseTemporaryAdapter extends PagingBaseAdapter<CaseData> {
    /**
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // String text = getItem(position);
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.case_item_temporary_list_item, null);
        }
        ...
        try {
         ...
         //   tv = (TextView) convertView.findViewById(R.id.case_item_in_list_item_docount_tv);
          //  tv.setText(String.valueOf(tempData.caseDoItemCount));
