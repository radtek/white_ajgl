package orcode.pubsec.taiji.com.business.util.GPSUtil;
...
public class Gps{
    ...
    public Gps(Context ctx) {
      ...
      //  locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 10000, 10, locationListener, Looper.myLooper());
