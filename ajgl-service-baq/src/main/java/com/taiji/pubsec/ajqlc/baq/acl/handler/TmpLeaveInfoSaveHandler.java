...
@Service
public class TmpLeaveInfoSaveHandler implements SecureBusDataHandler{
	
	public static final String MARK = "SecureBusData_TmpLeaveInfo_Save_Handler" ; 
	...
	public void handle(Object busData) {
		...
		TmpLeaveInfo entity = (TmpLeaveInfo)obj[0] ;
