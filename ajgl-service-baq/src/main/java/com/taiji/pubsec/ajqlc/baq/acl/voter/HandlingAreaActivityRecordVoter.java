...
public class HandlingAreaActivityRecordVoter extends CustomizedAclEntryVoter{

	public HandlingAreaActivityRecordVoter(AclService aclService,
	...
	public int vote(Authentication authentication, MethodInvocation object, Collection<ConfigAttribute> attributes) {
		...
		for(ConfigAttribute attr : attributes) {
    		...
    		while(it.hasNext()){
    			...
    			for(String uastr:Constant.HANDLING_AREA_ACTIVITY_RECORD_ADMIN_AUTH){
