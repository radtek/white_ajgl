...
<body id="validformAskRoom" class="validform m-ui-layer-body">
	<div class="m-ui-layer-box">
		<div class="m-ui-layer-content">
			...
			<div class="row row-mar">
				<div class="col-xs-5">
					<label class="control-label">房间名称：<span
			...
			<div class="row row-mar">
				...
				<div class="col-xs-6">
					<select id="status" class="form-control input-sm select2-noSearch">
			...
			<div class="row row-mar">
				...
				<div class="col-xs-6">
					<select id="type" class="form-control input-sm select2-noSearch">
...
<script type="text/javascript"
	src="<%=context%>/scripts/ajgl/askRoom/newOrUpdateAskRoom.js"></script>
<script type="text/javascript"
