	...
	<div id="c-center">
		...
		<div id="c-center-right">
			<div id="c-center-right-content">
				...
				<div class="row">
				<div  class="col-xs-7" >				
					<button class="btn btn-primary" id="unusual"><span class="glyphicon glyphicon-play-circle micon-lg"></span>异常识别</button>
					...
					<div class="row">
						...
						<div id="tabs" class="m-ui-tabs" style="width: 42%; border: 1px solid #666;float:right; margin-left: 30px;">
							...
							<div id="tabs-1" style="height:500px;">
								<table id="askRoomUseAbnormalTable"	class="table table-bordered table-hover m-ui-table-whole"
...
<script type="text/javascript"
	src="<%=context%>/scripts/ajgl/handlingAreaSupervision/askRoomInfo.js"></script>
</html>