...
<body id="validformLocker" class="validform m-ui-layer-body">
	<div class="m-ui-layer-box">
		<div class="m-ui-layer-content">
			...
			<div class="row row-mar">
				<div class="col-xs-3">
					<label class="control-label">区号：<span class="red-star">*</span></label>
				</div>
				<div class="col-xs-6">
					<input id="areaCode" type="text" class="form-control input-sm valiform-keyup form-val" datatype="*1-25" nullmsg="请填写区号"  errormsg="不可超过25个字符">
				</div>
			</div>
			<div class="row row-mar">
				<div class="col-xs-3">
					<label class="control-label">柜号：<span class="red-star">*</span></label>
				</div>
				<div class="col-xs-6">
					<input id="lockerCode" type="text" class="form-control input-sm valiform-keyup form-val" datatype="*1-25" nullmsg="请填写柜号"  errormsg="不可超过25个字符">
				</div>
			</div>
			<!-- <div class="row row-mar">
				<div class="col-xs-3">
...
<script type="text/javascript"
	src="<%=context%>/scripts/ajgl/locker/newOrUpdateLocker.js"></script>
<script type="text/javascript"
