			...
			<div id="c-center-right-content">
				...
				<div class="basic-query-out">
					<div class="basic-query">
						<input id="nameText" type="text" class="form-control input-sm" value="其他房间名称模糊查询"
							onBlur="if(!value){value=defaultValue;this.style.color='#aaa'}"
							onFocus="if(value==defaultValue){value='';this.style.color='#000'}"
							style="color: #aaa;">
						<button class="btn btn-primary btn-sm searchOR">查询</button>
				...
				<div class="m-ui-searchbox  advanced-query">
					<div class="m-ui-searchbox-con">
						...
						<div class="row row-mar">
							<div class="col-xs-3">
								<div class="col-xs-6">
									<label class="control-label">其他房间编号：</label>
								</div>
								<div class="col-xs-6">
							...
							<div class="col-xs-3">
								<div class="col-xs-6">
									<label class="control-label">其他房间名称：</label>
								</div>
								<div class="col-xs-6">
							...
							<div class="col-xs-3">
								...
								<div class="col-xs-6">
									<select id="status" class="form-control input-sm select2-noSearch allowClear"></select>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="col-xs-6">
						...
						<div class="row row-mar">
							...
							<div class="col-xs-3 m-ui-btn-box">
								<button class="btn btn-primary btn-sm searchOR">查询</button>
								<button id="resetOR" class="btn btn-default btn-sm">重置</button>
							</div>
						</div>
				...
				<div class="fixed-a">
					<div class="m-ui-title1">
						...
						<div class="m-ui-caozuobox">
							<button id="newOR" class="btn btn-primary">新增</button>
							<button id="updateOR" class="btn btn-success">修改</button>
							<button id="deleteOR" class="btn btn-danger">删除</button>
							<button id="enabledOR" class="btn btn-success">启用</button>
							<button id="disableOR" class="btn btn-danger">停用</button>
						</div>
					</div>
				</div>
				<!--悬浮操作层-->
				<div id="c-center-right-content-block">
					<div class="m-ui-table">
						<table id="otherRoomTable" class="table table-bordered table-hover m-ui-table-whole" cellspacing="0" width="100%">
...
<script type="text/javascript"
	src="<%=context%>/scripts/ajgl/otherRoom/otherRoomList.js"></script>
<script type="text/javascript"
