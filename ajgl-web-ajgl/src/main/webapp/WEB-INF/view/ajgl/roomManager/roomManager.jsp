	...
	<div id="c-center">
		...
		<div id="c-center-right">
			<div id="c-center-right-content">
				...
				<div class="fixed-a">
<div class="m-ui-title1"><h1>办案区各房间情况查看</h1></div>
</div>
<!--悬浮操作层-->
<div class="row">
    <div class="col-xs-6" style="border-right: 1px solid #ddd;"><div class="m-ui-title-lg" style=" margin-top: 15px;"><h2>讯（询）问室管理</h2></div>
                                <div class="room-only">
                      <ul>
                    ...
                    <div class="m-ui-title-lg" style=" margin-top: 15px;"><h2>其它房间</h2></div>
                      ...
                      <ul>
							<li id="template2" style="display: none;" class="fi-ceng-out">
								<h2 class="room-name"></h2><p class="wait-num"></p><span class="state-mark"></span>
								<div class="fi-ceng box-storage-ceng room-ceng"
									style="display: none;">
									<h4 id="roomName"></h4>
									<div class="alert">
										<p class="row"><span class="color-gray pull-right">办案区使用单</span><span class="color-gray">被讯询问人</span></p>
									</div>
								</div>
							</li>
						</ul>
...
<script type="text/javascript"
	src="<%=context%>/scripts/ajgl/roomManager/roomManager.js"></script>
<script type="text/javascript"
