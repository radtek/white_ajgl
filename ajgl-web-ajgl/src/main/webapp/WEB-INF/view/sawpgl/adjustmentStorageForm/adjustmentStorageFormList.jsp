			...
			<div id="c-center-right-content">
				...
				<div class="basic-query-out">
					<div class="basic-query">
						<input id="codeText" type="text" class="form-control input-sm" value="调整单编号模糊查询"
				...
				<div class="m-ui-searchbox  advanced-query">
					<div class="m-ui-searchbox-con">
						...
						<div class="row row-mar">
							...
							<div id="asfDateRange" class="col-xs-6 dateRange">
...
<script type="text/javascript"
	src="<%=context%>/scripts/sawpgl/adjustmentStorageForm/adjustmentStorageFormList.js"></script>
</html>