...
<body id="validform" class="validform m-ui-layer-body">
	<div class="m-ui-layer-content">
		...
		<div class="row row-mar">
			<div class="col-xs-5">
				<label class="control-label">架号+箱号：</label>
			</div>
			<div class="col-xs-6">
				<span id="code"></span>
			</div>
		...
		<div class="row row-mar">
			<div class="col-xs-5">
				<label class="control-label">是否保险箱：</label>
			</div>
			<div class="col-xs-6">
				<span  id="lockerStatus" algin="left"></span>
			</div>
			<!-- <span class="red-star">*</span> -->
		</div>
		<div class="row row-mar">
...
<script type="text/javascript"
	src="<%=context%>/scripts/sawpgl/lockerMaintain/modifyLocker.js"></script>
</html>