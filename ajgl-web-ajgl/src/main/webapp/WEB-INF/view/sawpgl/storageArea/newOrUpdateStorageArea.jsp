...
<body id="saValidform" class="validform m-ui-layer-body">
	<div class="m-ui-layer-box">
		<div class="m-ui-layer-content">
			...
			<div class="row row-mar">
				<div class="col-xs-5">
					<label class="control-label">物证保管区名称：<span class="red-star">*</span></label>
				</div>
				<div class="col-xs-6">
			...
			<div class="row row-mar">
				<div class="col-xs-5">
					<label class="control-label">物证保管区详细地址：<span
...
<script type="text/javascript"
	src="<%=context%>/scripts/sawpgl/storageArea/newOrUpdateStorageArea.js"></script>
<script type="text/javascript"
