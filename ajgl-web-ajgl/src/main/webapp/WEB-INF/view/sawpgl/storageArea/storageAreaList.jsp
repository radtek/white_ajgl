			...
			<div id="c-center-right-content">
				...
				<div class="fixed-a">
					<div class="m-ui-title1">
						...
						<div class="m-ui-caozuobox">
							...
							<button id="saDelete" class="btn btn-danger">删除</button>
				...
				<div id="c-center-right-content-block">
					<div class="m-ui-table">
						<table id="saTable" class="table table-bordered table-hover m-ui-table-whole" cellspacing="0" width="100%">
...
<script type="text/javascript"
	src="<%=context%>/scripts/sawpgl/storageArea/storageAreaList.js"></script>
</html>