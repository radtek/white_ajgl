			...
			<div id="c-center-right-content">
				...
				<div class="basic-query-out">
					<div class="basic-query">
						<input id="simpleCode" type="text" class="form-control input-sm" value="出库单编号模糊查询"
						...
						<div class="m-ui-searchbox-con">
							...
							<div class="row row-mar">
								...
								<input type="hidden" id="dtfmt" class="dateFmt"
						      	...
						      	<div class="col-xs-3"> <label class="control-label">出库时间：</label></div>
							...
							<div class="row row-mar">
								...
								<div style="display:none;" class="col-xs-3 text-right">
									<input id="sf" name="sf" type="checkbox" class="icheckbox" checked>&nbsp;&nbsp;只显示我的出库单
								</div>
							</div>
							<div class="row row-mar">
								<div class="col-xs-3">
				...
				<div class="fixed-a">
					<div class="m-ui-title1">
						...
						<div class="m-ui-caozuobox">
							...
							<button class="btn btn-danger delOut">删除</button>
				...
				<div id="c-center-right-content-block">
					<div class="m-ui-table">
						<table id="storageOutRecordTable"
...
<script type="text/javascript"
	src="<%=context%>/scripts/sawpgl/storageOut/storageOutRecord.js"></script>
</html>