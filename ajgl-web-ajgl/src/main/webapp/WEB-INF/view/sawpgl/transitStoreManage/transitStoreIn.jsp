		...
		<div id="c-center-right">
			<div id="c-center-right-content">
				...
				<div class="m-ui-searchbox  advanced-query">
					...
					<div class="row row-mar">
						<div class="col-xs-3">
						    <div class="col-xs-8"> <label class="control-label">对应嫌疑人/物品持有人：</label></div>
						    <div class="col-xs-4"><input type="text" id="suspectName" class="form-control input-sm"></div>
						</div>
						<div class="col-xs-3 text-right">显示我的入库单&nbsp;&nbsp;<input name="isShow" type="checkbox" class="icheckbox sxcheckbox">
						</div>
			...
			<!--悬浮操作层-->
			<div class="fixed-a">
				<div class="m-ui-title1"><h1>暂存物品入库</h1>
			...
			<div id="c-center-right-content-block">
				<div class="m-ui-table" >
			        <table id="transitStoreInTable" class="table table-bordered table-hover m-ui-table-whole" cellspacing="0" style="width:100%">
...
<script type="text/javascript"
	src="<%=context%>/scripts/sawpgl/transitStoreManage/transitStoreIn.js"></script>
</html>