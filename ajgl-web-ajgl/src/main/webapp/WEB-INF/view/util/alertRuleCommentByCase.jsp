						...
						<div class="right-inner" style="padding-top: 30px; display: none;" id="body">
							...
							<div class="row row-mar">
								...
								<div class="row row-mar">
									...
									<div class="col-xs-8">
										<div class="m-icheck-group">
											...
											<p class="col-xs-4">
												<input type="checkbox" class="icheckbox" value="<%= Constant.YJFS_DX%>" name="yjfs"> 短信
											</p>
										</div>
									</div>
								</div>
								...
								<div class="row row-mar">
									...
									<div class="col-xs-8">
										<textarea id="functionExplain" class="form-control input-sm" ></textarea>
									</div>
								</div>
								<div class="row row-mar">
									<div class="col-xs-3">
								...
								<div class="row row-mar">
									...
									<div class="col-xs-8">
										<div class="m-icheck-group">
											...
											<p class="col-xs-4">
												<input type="checkbox" id="updateDx" value=<%= Constant.YJFS_DX%> class="icheckbox" name="updateYjfs"> 短信
											</p>
										</div>
									</div>
								</div>
								...
								<div class="row row-mar">
									...
									<div class="col-xs-10">
										<div class="row m-icheck-group"
											...
											<p class="col-xs-8">
												预警提前时间：&nbsp;<input class="form-control input-sm  m-inline" id="updateYjtqsj" size="11" value=""
													style="width: 60px;"> 分钟
											</p>
										</div>
										<div class="alert alert-info"
											style="width: 70%; min-width: 620px;">
											<h4 class="font14 m-bold">预警时间：</h4>
											<p class="m-line"></p>
											<p class="row-mar">
												<span style="display: inline-block; width: 180px;">首次进入办案区时长：</span><input id="firstAlertTimeAt"
											...
											<p class="m-line"></p>
											<p class="row-mar">
												<span style="display: inline-block; width: 180px;">每日第二次触发消息时间：</span><input id="secondAlertTimeAt"
													class="form-control input-sm  m-inline" style="width: 60px;">
												小时 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 消息接收用户/角色
												<button class="btn btn-xs btn-bordered" id="selUser2">选择用户</button>
												<button class="btn btn-xs btn-bordered" id="selRole2">选择角色</button>
											</p>
											<p class="row-mar" id="user2">
												<span class="color-gray">用户：</span>
											</p>
											<p id="role2">
												<span class="color-gray">角色：</span>
