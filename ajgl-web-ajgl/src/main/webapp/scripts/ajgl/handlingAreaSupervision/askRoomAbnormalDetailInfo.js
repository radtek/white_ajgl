(function($) {
	...
	//	window.location.href = context + "/handlingAreaSupervision/askRoomToDeal.action?askRoomId="+ askRoomId;
	});
	//刷新
	$(document).on("click","#refresh",function(){
	//	window.location.href = context + "/handlingAreaSupervision/showAskRoomInfoDetail.action?askRoomId="+ askRoomId;
	});
