(function($){
	...
	function initPageField(id){
		$.ajax({
			url: context + '/transitStoreArea/findTransitStoreAreaById.action',
			type:"POST",	
			dataType:"json",
	...
	function verifyCodeIsOnly(){
		...
		$.ajax({
			url:context +'/transitStoreArea/verifyCodeIsOnly.action',
			type:'post',
			dataType:'json',
			ajaxLoading:false,
			data:gData,
	...
	function verifyNameIsOnly(){
		...
		$.util.objToStrutsFormData(storageAreaBean, "storageAreaBean", gData);
		$.ajax({
			url:context +'/transitStoreArea/verifyNameIsOnly.action',
			type:'post',
			dataType:'json',
			ajaxLoading:false,
			data:gData,
	...
	function save(){
		...
		verifyCodeIsOnly();
		verifyNameIsOnly();
		var url = context + '/transitStoreArea/newTransitStoreArea.action';
		if(!$.util.isBlank(saId)){
			url = context + '/transitStoreArea/updateTransitStoreArea.action';
		}
