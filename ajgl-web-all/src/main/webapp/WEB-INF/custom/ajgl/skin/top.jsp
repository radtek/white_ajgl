...
<li><d:ss resource="/topbaq/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="ajgl" href="###"'
				value='<span class="link-icon aj-icon-1"></span><i>智能办案区管理</i>'/></li>
<li><d:ss resource="/ajjkgl/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="ajjk" href="###"'
				value='<span class="link-icon aj-icon-2"></span><i>案件监控管理</i>'/></li>
<li><d:ss resource="/saqpgl/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="sawpgl" href="###"'
				value='<span class="link-icon aj-icon-3"></span><i>涉案物品管理</i>'/></li>
<li><d:ss resource="/xxtx/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="xxtx" href="###"'
				value='<span class="link-message-icon"></span><i>我的消息</i>'/></li>
  ...
  <li><div class="nav-ceng-out"><a href="###" class=""><span class="link-menu-icon"></span><i>系统导航</i></a>
         <div class="nav-ceng nav-systems" style="display: none;">
          ...
          <li><d:ss resource="/topbaq/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="ajgl" href="###"'
				value='<span class="icon aj-icon-1"></span>智能办案区管理'/></li>
          <li><d:ss resource="/ajjkgl/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="ajjk" href="###"'
				value='<span class="icon aj-icon-2"></span>案件监控管理'/></li>
<li><d:ss resource="/saqpgl/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="sawpgl" href="###"'
				value='<span class="icon aj-icon-3"></span>涉案物品管理'/></li>
	<li><d:ss resource="/xtgl/*" type="a"
				request="${pageContext.request}"
				otherAttribute='class="xtgl" href="###"'
				value='<span class="icon aj-icon-4"></span>系统管理'/></li>
          </ul>
</div>
</div></li>
...
$(document).on("click", ".sawpgl", function(){
	window.location.href = context + "/storageIn/toStorageInRecord.action?clickOrder=1&&clickListOrder=0" ;
});	
