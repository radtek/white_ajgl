...
<div id="accordion" class="m-ui-accordion" style="display: none">
	<h3><span class="leftmenu-icon icon-3"></span><span class="moveSpan"><a myHref="<%=request.getContextPath()%>/dictionaryType/toDictionaryType.action"><span class="leftH3Span">数据字典</span></a></span></h3><div></div>
	...
	<h3><span class="leftmenu-icon icon-1"></span><span class="moveSpan"><span class="leftH3Span">预警规则设置</span></span></h3>
		<div>
			<ul>
